  ...
  <div className="flex-1 flex flex-col">
    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      <div className="inline-flex items-center text-xs sm:text-sm bg-blue-100 text-[rgba(24,185,213,1)] px-2.5 py-1 rounded-full">
        <img src="/Appointment/pmc.png" alt="PMC Verified" className="w-4 h-4 sm:w-5 sm:h-5" />
...
<div className="p-4 sm:p-6 shadow-xl rounded-lg w-full max-w-3xl 2xl:max-w-5xl mx-auto">
  ...
  <p className="text-xs  text-[rgba(100,100,100,1)]  font-inter  py-4 sm:py-6">
    ...
    Medical and Dental Council. She is a member of the Pakistan Society of
    Child Neurology (CNS Pakistan), a member of the International Child
    Neurology Association (ICNA), a member of the Asian Oceanian Child
    Neurology Association (AOCNA), and an executive member of the Pakistan
    Paediatric Association Punjab (PPA). She is currently working as an
    Assistant Professor and Head of the Department of Paediatric Neurology
    at the Children’s Hospital and Institute of Child Health, Faisalabad.
    She is also a supervisor of the FCPS training program of the College of
    Physicians and Surgeons Pakistan. 

    According to the Pakistan Journal of Neurological Sciences, Pakistan has
    a crippling shortage of pediatric neurologists—about one per one million
    population—therefore, the work that Dr. Iram Javed does is of the utmost
    importance and a necessity for the country. Her special areas of interest,
    apart from General Paediatric Neurology, are childhood epilepsy,
    neurometabolic disorders, and neurogenetic disorders.
  </p>
</div>
...
<div className="p-4 sm:p-6 shadow-xl rounded-lg w-full max-w-3xl 2xl:max-w-5xl mx-auto my-2">
  ...
  <div className="flex flex-wrap gap-1 mb-2 sm:mb-3">
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs">Epilepsy</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs">Headache</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs">CNS Infection</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs">Development Delay</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs">Cerebral Palsy</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs">Stroke</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs">Behaviour Problem</p>
  </div>

  {/* Second line with 5 tags */}
  <div className="flex flex-wrap gap-2 sm:gap-3 mb-2 sm:mb-3">
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs font-medium">Neuromuscular Disorders</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs font-medium">Neuropathy</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs font-medium">Myopathy</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs font-medium">Movement Disorder</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs font-medium">Neuro Rehab</p>
  </div>

  {/* Last line with 2 tags */}
  <div className="flex flex-wrap gap-2 sm:gap-3">
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs font-medium">Metabolic Disorders Management</p>
    <p className="bg-[rgba(246,246,246,1)] text-[rgba(100,100,100,1)]  font-inter rounded-lg px-3 py-2  text-xs font-medium">EEG</p>
  </div>
</div>
...
<div className="bg-white shadow-md rounded-lg p-4 sm:p-6 w-full max-w-3xl 2xl:max-w-5xl mx-auto">
  ...
  <ul className="list-disc pl-5 pr-32 text-[rgba(100,100,100,1)] text-xs  ">
    <li>
      ...
      <p>Health, Faisalabad,Children Hospital & Institute Of Child Health Lahore</p>
    </li>
  </ul>
</div>
...
<div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full max-w-3xl 2xl:max-w-5xl mx-auto my-4">
      ...
      <div key={index} className="border-b pb-4">
        ...
        <div className="flex flex-wrap sm:flex-nowrap justify-between items-center gap-2">
          <div className="flex items-center gap-2">
            <h3 className="font-medium text-gray-800 break-words">{review.name}</h3>
          ...
          {/* Time on the right */}
          <p className="text-xs font-semibold  text-[rgba(100,100,100,1)]">{review.time}</p>
        </div>
  ...
  <div className="text-center mt-4">
    <a href="#" className="text-[rgba(29,166,120,1)] font-medium hover:underline">
      View all 10 Reviews
    </a>
  </div>
</div>
...
<div className="border-t my-4"></div>
    ...
    <div className=" flex flex-wrap justify-between mt-4">
      <p className="text-[rgba(100,100,100,1)] text-sm font-semibold">Days:</p>
      <p className="text-black text-sm font-semibold">Tue, Wed, Thu, Fri, Sat</p>
    </div>
