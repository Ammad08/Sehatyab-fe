    ...
    <div className="h-full py-10 bg-gray-100 flex flex-col justify-center items-center ">
      <div className='container max-w-6xl mx-auto px-4'>
        ...
        <div className=" flex flex-col md:flex-row justify-between items-start space-y-6 md:space-y-0">
          {/* Left Section */}
          <div className='w-2/3'>
            <h1 className="text-md text-[#FFBC0A] font-semibold  tracking-wider font-commissioner mb-2">Our Consultants</h1>
            <h1 className="text-2xl md:text-2xl lg:text-4xl  font-poppins font-bold pr-8 text-[rgba(6,104,95,1)]  md:mb-6">
        ...
        {/* Consultants Grid */}
        <div className="container mx-auto mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
