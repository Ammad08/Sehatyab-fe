...
//         <Link href="/" className="hover:text-[rgba(24,77,81,1)]">HOME</Link>
//         <span className="font-bold">{">"}</span>
//         <Link href="/doctors" className="hover:text-[rgba(24,77,81,1)]">DOCTORS</Link>
//         <span className="font-bold">{">"}</span>
...
<div className="max-w-3xl mx-auto mt-6 p-2 sm:p-4 rounded-full w-full">
  <div className="bg-white shadow-md rounded-full flex flex-col sm:flex-row items-center border border-gray-300 w-full">
    ...
    {/* Search Button */}
    <button onClick={handleSearch} className="bg-[rgba(29,166,120,1)] font-semibold text-white px-6 py-2 rounded-b-full sm:rounded-r-full sm:rounded-bl-none flex items-center justify-center w-full sm:w-auto hover:bg-green-600">
      <span>Search</span>
    </button>
