...
export default function AppointmentForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    specialization: prefilledSpecialization,
    consultant: prefilledConsultant,
    dateOfAppointment: "", // Changed to match API field name
    email: "",
    phone: "",
    additionalComments: "", // Changed to match API field name
    service: "Psychiatric Consultation", // Added to match API, can be dynamic if needed
  });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:py-10">
      <div className="shadow-lg py-8 px-4 rounded-lg md:px-12 max-w-6xl lg:max-w-7xl">
        <p className="text-[rgba(85,85,85,1)] mb-4 text-left text-sm">
          To request an appointment, please fill out the following form. Please provide your
          preferred date and time for the appointment. Our team will review your request and
          contact you to confirm the appointment based on the availability of our doctors.
        </p>
        ...
        {error && (
          <div className="bg-red-400 text-white text-center py-2 rounded-md mb-4">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-[rgba(6,104,95,1)] text-sm font-poppins font-bold">
              FULL NAME*
            </label>
            <input
              type="text"
