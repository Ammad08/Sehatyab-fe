      ...
      <div className="relative z-10 container mx-auto px-6 text-white">
        <section className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center text-sm mb-3">
            ...
            <p className="font-semibold font-poppins">Contact</p>
          </div>

          {/* Heading & Description */}
          <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-poppins font-bold mb-4 text-left">
            Contact Us
          </h1>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <p className="text-white font-poppins font-medium max-w-xl text-left leading-relaxed">
              Get in touch with us for any inquiries or assistance. We are here
              to help you with all the problems related to your health.
            </p>
