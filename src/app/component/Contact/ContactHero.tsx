...
const ContactHero = () => {
    return (
        <main className="relative h-[50vh] bg-[url('/About/AboutHero.jpeg')] bg-cover bg-center flex items-center">
            {/* Overlay */}
            ...
            <div className="relative z-10 container mx-auto px-6 text-white">
                <section className="max-w-6xl mx-auto">
                    ...
                    {/* Heading & Description */}
                    <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-poppins font-bold mb-4 text-left">Contact Us</h1>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                        ...
                        <div className="flex  items-center gap-4 ">
                            ...
                            <div>
                                <p className="font-semibold font-poppins text-white text-lg">4.8 Google Rating</p>
