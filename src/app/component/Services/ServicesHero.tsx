...
const ServicesHero = () => {
    return (
        <main className="relative h-[50vh] bg-[url('/Services/serviceHero.png')] bg-cover bg-center flex items-center">
            {/* Overlay */}
            ...
            <div className="relative z-10 container mx-auto px-6 text-white">
                <section className="max-w-6xl mx-auto">
                    ...
                    {/* Heading & Description */}
                    <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 text-left">Our Services</h1>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                        <p className="text-white font-poppins font-medium max-w-xl text-left leading-relaxed">
                            We are committed to sustainability and innovation, providing Best services to our customers.
                        </p>
